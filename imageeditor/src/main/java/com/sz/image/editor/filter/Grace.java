 ...
 */
public class Grace extends Filter{

  private final String GRACE = "grace";
  private final int[] mArgb = {10, 0, 230, 0};
  ...
  public Grace(Context context, String targetPath, int width, int height) {
    mContext = context;
  ...
  public void assignFilterImage(TextView textView, ImageView imageView) {
    ...
    Glide.with(mContext)
            ...
            .into(imageView);
    String fileName = Type.GRACE.getName();
