...
public class Brightness extends Filter {
  ...
  private final String GRAYSCALE = "brightness";
  ...
  public Brightness(Context context, String targetPath, int width, int height) {
    mContext = context;
  ...
  public void assignFilterImage(TextView textView, ImageView imageView) {
    ...
    Glide.with(mContext)
            ...
            .bitmapTransform(new BrightnessFilterTransformation(mContext, 0.1f), new CropSquareTransformation(mContext))
    ...
    String filterName = Type.BRIGHTNESS.getName();
      ...
      protected Drawable doInBackground(Void... params) {
        ...
        try {
          ...
          drawable = Glide.with(mContext)
                  ...
                  .bitmapTransform(new BrightnessFilterTransformation(mContext, 0.1f))
