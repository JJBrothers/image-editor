 ...
 */
public class Elegance extends Filter{

  private final String ELEGANCE = "elegance";
  private final int[] mArgb = {20, 0, 0, 230};
  ...
  public Elegance(Context context, String targetPath, int width, int height) {
    mContext = context;
  ...
  public void assignFilterImage(TextView textView, ImageView imageView) {
    ...
    Glide.with(mContext)
            ...
            .bitmapTransform(new BrightnessFilterTransformation(mContext, 0.1f), new ColorFilterTransformation(mContext, Color.argb(mArgb[0], mArgb[1], mArgb[2], mArgb[3])), new CropSquareTransformation(mContext))
            .dontAnimate()
            .thumbnail(FILTER_IMAGE_LOADING_ALPHA)
            .into(imageView);
    String fileName = Type.ELEGANCE.getName();
      ...
      protected Drawable doInBackground(Void... params) {
        ...
        try {
          ...
          drawable = Glide.with(mContext)
                  ...
                  .bitmapTransform(new BrightnessFilterTransformation(mContext, 0.1f),new ColorFilterTransformation(mContext, Color.argb(mArgb[0], mArgb[1], mArgb[2], mArgb[3])))
