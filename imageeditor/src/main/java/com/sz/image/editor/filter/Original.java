...
public class Original extends Filter {
  ...
  public Original(Context context, String targetPath, int width, int height) {
    mContext = context;
  ...
  public void assignFilterImage(TextView textView, ImageView imageView) {
    ...
    String filterName = Type.ORIGINAL.getName();
  ...
  public void getBitmap(final Callback callback) {
    ...
    new AsyncTask<Void, Void, Drawable>() {
      ...
      protected void onPreExecute() {
        System.out.println(isFragmentShowingOnScreen+"<- 다이얼로크 불린");
        super.onPreExecute();
      ...
      protected Drawable doInBackground(Void... params) {
        ...
        try {
          ...
          drawable = Glide.with(mContext)
                  ...
                  //.bitmapTransform(new FitCenter(pool))
