 ...
 */
public class Winter extends Filter {

  private final String WINTER = "winter";
  private final int[] mArgb = {30, 100, 149, 237};
  ...
  public Winter(Context context, String targetPath, int width, int height) {
    mContext = context;
  ...
  public void assignFilterImage(TextView textView, ImageView imageView) {
    ...
    Glide.with(mContext)
            ...
            .into(imageView);
    String fileName = Type.WINTER.getName();
