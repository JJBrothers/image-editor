 ...
 */
public class Rememberance extends Filter {

  private final String REMEMBERANCE = "rememberance";
  ...
  public Rememberance(Context context,String targetPath, int width, int height){
    mContext = context;
  ...
  public void assignFilterImage(TextView textView, ImageView imageView) {
    ...
    Glide.with(mContext)
            ...
            .bitmapTransform(new BrightnessFilterTransformation(mContext, 0.1f), new GrayscaleTransformation(mContext), new CropSquareTransformation(mContext))
            .dontAnimate()
            .thumbnail(FILTER_IMAGE_LOADING_ALPHA)
            .into(imageView);
    String filterName = Type.REMEMBERANCE.getName();
      ...
      protected Drawable doInBackground(Void... params) {
        ...
        try{
          ...
          drawable = Glide.with(mContext)
                  ...
                  .bitmapTransform(new BrightnessFilterTransformation(mContext, 0.1f),new GrayscaleTransformation(mContext))
